...
parser.add_argument("--train_set", type=str, default="data/input/train.pkl")
parser.add_argument("--test_set", type=str, default="data/input/test.pkl")
parser.add_argument("--ptw_ids", type=str, default="data/input/ptw_ids.pkl")
